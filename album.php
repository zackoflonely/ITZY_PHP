...
<div>
<h1 style="text-align:center; padding-top:10vh; padding-bottom: 10vh; font-weight:bold;">DISCOGRAPHY</h1>
<div class="row" style="margin:0 0 0 15vw;">
  <div class="col-sm-3" style="margin-right:1.5vw;">
  ...
  <div class="col-sm-3" style="margin-right:1.5vw;">
    <div class="card" style="width: 18rem;">
      <img src="assets/album2.png" class="card-img-top" alt="...">
      <div class="card-body">
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      </div>
    </div>
...
<div class="row" style="margin:5vh 0 0 15vw;">
  <div class="col-sm-3" style="margin-right:1.5vw;">
    <div class="card" style="width: 18rem;">
  ...
  <div class="col-sm-3" style="margin-right:1.5vw;">
    <div class="card" style="width: 18rem;">
      <img src="assets/album6.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      </div>
    </div>
